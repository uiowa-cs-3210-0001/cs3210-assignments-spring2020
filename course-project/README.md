...
**The project due date is midnight, Wednesday, May 6th.** Late project submissions will be subject to a penalty of a 25% reduction in points for every 24-hour period they are late.
...
**The weekly updates are due at midnight every Wednesday, starting from Wednesday, April 8th, up to and including Wednesday, April 29th**.
...
It's entirely possible to develop the project from beginning to end in [repl.it](https://repl.it/). If you are already familiar with a desktop IDE/development workflow, please feel free to develop on your machine and publish on [Github](https://github.com/), otherwise I suggest keeping it in [repl.it](https://repl.it/). Please do let me know what you choose.
